...
pub struct IMAGE_OPTIONAL_HEADER32 {
    ...
    pub base_of_data: LittleEndian<u32>,
    /// Image base address
    pub image_base: LittleEndian<u32>,
    /// Section alignment
    ...
    pub size_of_stack_reserve: LittleEndian<u32>,
    /// Size of stack commit
    pub size_of_stack_commit: LittleEndian<u32>,
    /// Size of heap reserve
    pub size_of_heap_reserve: LittleEndian<u32>,
    /// Size of heap commit
    pub size_of_heap_commit: LittleEndian<u32>,
    /// Loader flags
...
impl IMAGE_OPTIONAL_HEADER32 {
    ...
    /// Returns the size of the initialized data section.
    pub fn size_of_initialized_data(&self) -> u32 {
        self.size_of_initialized_data.into()
    }

    /// Sets the size of the initialized data section.
    ...
    /// Sets the size of the uninitialized data section.
    ...
    /// Returns the base address of the data section.
    pub fn base_of_data(&self) -> u32 {
        self.base_of_data.into()
    }

    /// Sets the base address of the data section.
    pub fn set_base_of_data(&mut self, value: u32) {
        self.base_of_data = value.into();
    }
